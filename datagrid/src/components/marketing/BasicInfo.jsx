...
const BasicInfo = (props) => {
  ...
  const handleOpenTodos = () => setOpenTodos(true);
  const handleCloseTodos = (save) => {
    setOpenTodos(false);
  };
  ...
  return (
    <InfoWrapper>
      ...
      <InfoAction>
        ...
        {alarm && <Button onClick={() => setOpenTodos(true)}>할일추가</Button>}
        <Modal open={openTodos} onClose={handleCloseTodos}>
          <Todos handleClose={handleCloseTodos} />
        </Modal>
      </InfoAction>
    </InfoWrapper>
  );
